...
getusername(event:Event){   //function for handelchnge 
  this.username=(event.target as HTMLInputElement).value //to get vaue when changed
       //to set username to chaned value
